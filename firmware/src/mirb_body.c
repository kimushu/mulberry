...
*/
#define MIRB_EMBEDDED
#define ENABLE_PYBREPL
...
#elif defined(ENABLE_PYBREPL)
#define ENABLE_READLINE
#include <pybrepl.h>
#define MIRB_ADD_HISTORY(line) do {} while(0)
#define MIRB_READLINE(ch) pybreplReadLine(ch)
#define MIRB_LINE_FREE(line) pybreplFree(line)
#endif
...
#ifdef MIRB_EMBEDDED
int
mirb_main(int verbose, int mrb_argc, char **mrb_argv)
#else   /* !MIRB_EMBEDDED */
int
